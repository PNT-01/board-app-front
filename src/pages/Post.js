...
import { post } from '../apis/BoardApi'
    ...
    <Container maxWidth='md' style={{marginTop: '3%', textAlign: 'center'}}>
        ...
        <form onSubmit={handlepost}>
            ...
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                      xs={10}>
                        <Button type='button' variant='outlined' onClick={openFileInput}>파일선택</Button>
                        <input type='file'
                               multiple
                               name='uploadFiles'
                               id='uploadFiles'
            ...
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                ...
                <Grid item
                      xs={10}>
                        <Container component='div' name='preview' id='preview' style={{display: 'felx'}}></Container>
                </Grid>
            </Grid>
            <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                <Grid item
